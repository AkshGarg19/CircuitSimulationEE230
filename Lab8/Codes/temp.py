...
# filename : This is name of the file containing the x and y values
filename = "IV-1N4148.txt"
Plot_Title = "Instrumental Amplifier Circuit"
#positionss = (0.000, 0.001, 0.002, 0.003, 0.004, 0.005, 0.006)
#labelss = (0, 1, 2, 3, 4, 5, 6)
#plt.xticks(positionss, labelss)
x_axis_label = "Vin"
y_axis_label = "ln(Is)"
...
# this is column no. from which actual data start. It lowest value is 0.
x_axis_colum_number = 0
# After x axis column, all further columns will be y axis columns
y_axis_column_start = x_axis_colum_number+1
...
if __name__ == '__main__':
    ...
    for column in range(0, number_of_curves_in_plot):
        plt.scatter(x_array_final,
                    y_array_final[column], label=legend_list[column])
...
# the first five entries of the dataset
    theta = np.polyfit(x_array_final[11:29], y_array_final[0][11:29],  1)
    x_temp = np.linspace(0, 1, 1001)
    y_line = theta[1] + theta[0]*x_temp

# Plotting the data points and the best fit line
    plt.plot(x_temp, y_line, 'r')
