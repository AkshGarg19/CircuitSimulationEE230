...
filename     = "r1"              #filename : This is name of the file containing the x and y values
...
if __name__ == '__main__':
    ...
    for column in range(0, number_of_curves_in_plot):
        plt.scatter(x_array_final , y_array_final[column],label = legend_list[column])
